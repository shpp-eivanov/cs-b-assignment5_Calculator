...
double getSimpleCalculationResult(double num1,
                         ...
                         double num2);
double getFinalStacksResult(Stack<double> numbersStack,
                            Stack<string> operatorsStack);
void calculateResultForTopStacksValues(Stack<double>& numbersStack,
                    Stack<string>& operatorsStack);
 ...
 * @param numbersStack      Stack of number values for current recursion
 * @param operatorsStack    Stack of operators for current recursion */
void calculateResultForTopStacksValues(Stack<double>& numbersStack, Stack<string>& operatorsStack){
